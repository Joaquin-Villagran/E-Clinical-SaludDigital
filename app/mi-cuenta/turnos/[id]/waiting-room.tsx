...
type Props = { sessionHref: string; scheduledStart: string; enabled: boolean };
...
export default function WaitingRoom({ sessionHref, scheduledStart, enabled }: Props) {
